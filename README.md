...
Implementations of core automata theory models and related formal language projects.
...
|------|------|------|------|
| DFA | [deterministic-finite-automata](https://github.com/05viktor/deterministic-finite-automata) | Regular languages, deterministic transitions | CLI simulator, string acceptance, sample game |
